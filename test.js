...
const plans = calculateWiringRestriction(1000, 150, 53, 25000, 500, 800, 46.2, -0.15241, -0.152412371, 37.8, 8.73, 9.33)
console.log(calculateWiring({ mode: 'single' }, 178, plans))
